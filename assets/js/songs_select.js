...
export function initSongsSelect() {
    document.addEventListener('DOMContentLoaded', () => {
        ...
        new Choices(select, {
            ...
            placeholderValue: 'Select songs...',
            searchPlaceholderValue: 'Search songs...',
            itemSelectText: '',
            callbackOnCreateTemplates: (template, classNames) => ({
                choice: (_, data) => {
                    const el = data.element;
                    const coverUrl = el?.dataset.cover || '/uploads/songs/default.png';
